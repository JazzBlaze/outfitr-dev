...
const custom = () => {
    ...
    const resultProduct = ScanningProducts[1]
    const similarProducts = [ScanningProducts[0],ScanningProducts[2]]
  ...
  return (
    <SafeAreaView style={{ backgroundColor: Colors.background, height: '100%', padding: 10}}>
      ...
      {scannerProduct ?<ScrollView >
          ...
          <View>
            <ThemedText style={{textAlign:"center",fontSize:22,lineHeight:22, marginVertical:20}}  type="header">Found a match for your prompt: "Find it in orange"</ThemedText>
          ...
          <View>
            <ThemedText  style={{marginVertical:20,fontSize:22,lineHeight:22}} type="header">We also found it in these colors</ThemedText>
            <FlatList
